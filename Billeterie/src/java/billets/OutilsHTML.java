...
public class OutilsHTML
{
    ...
    private void produireEntete(String client)
    {
        ...
        out.println("<tr class=\"TopMenu\">                    \n"
                ...
                + "                                   <input class=\"css-input\" type=\"text\" name=\"recherche\" id=\"recherche_textbox\" onkeyup=\"if (event.keyCode == 13) document.getElementById('BoutonRecherche').click()\">\n"
                + "                                   <img align=\"top\" class=\"BoutonRecherche\" src=\"http://i.imgur.com/Zlb38M3.png\" onclick=\"Rechercher()\" id=\"BoutonRecherche\">\n"
                + "                               </form>\n"
                + "                            </td>\n"
                + "                            <td class=\"MenuTopDroite\">\n"
